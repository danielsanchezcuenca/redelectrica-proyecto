...
BASE = "https://apidatos.ree.es/{lang}/datos/generacion/estructura-generacion"
...
def main():
    parser = argparse.ArgumentParser(description="Ingesta estructura-generacion -> GCS")
